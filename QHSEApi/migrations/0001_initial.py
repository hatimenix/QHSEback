# Generated by Django 4.1.7 on 2023-04-06 12:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dangers', models.ManyToManyField(null=True, to='QHSEApi.danger')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('danger_lie', models.ManyToManyField(null=True, to='QHSEApi.danger')),
                ('evenement', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='QHSEApi.evenements')),
            ],
        ),
        migrations.AddField(
            model_name='actions',
            name='danger',
            field=models.ManyToManyField(null=True, to='QHSEApi.danger'),
        ),
        migrations.AddField(
            model_name='actions',
            name='evenement',
            field=models.ManyToManyField(null=True, to='QHSEApi.evenements'),
        ),
        migrations.AddField(
            model_name='actions',
            name='processus',
