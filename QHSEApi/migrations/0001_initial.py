# Generated by Django 4.2 on 2023-06-07 15:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('autorisation', models.CharField(blank=True, choices=[('Control_total', 'Control total'), ('Lecture', 'Lecture'), ('collaboration_avec_suppression', 'Collaboration avec suppression'), ('collaboration_sans_suppression', 'Collaboration sans suppression')], max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Realisation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('control', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='previous_controls', to='QHSEApi.control')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='analyserisque',
            name='processus',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='QHSEApi.processus'),
        ),
        migrations.AddField(
            model_name='analyserisque',
            name='site',
