...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='membres',
            field=models.ManyToManyField(blank=True, related_name='groupes_membre', to='QHSEApi.userapp'),
        ),
        migrations.AddField(
            model_name='groupeuser',
            name='proprietaire_groupe',
            field=models.ManyToManyField(blank=True, related_name='groupes_proprietaire', to='QHSEApi.userapp'),
        ),
        migrations.CreateModel(
            name='Evenements',
            fields=[
